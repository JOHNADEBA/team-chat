...
import { NotFoundError, UnauthorizedError, ForbiddenError, ValidationError, } from "../utils/errors.js";
...
// Create room
router.post("/", authMiddleware, validateRoom, async (req, res) => {
...
// Add member to room
router.post("/:roomId/members", authMiddleware, validateAddMember, async (req, res) => {
    try {
        const roomId = getStringParam(req.params.roomId);
